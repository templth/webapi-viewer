...
describe('server', () => {
	describe('webapi', () => {
		it('should return resource hints for an existing path', (done) => {
			request(app)
		...
		it('should return 404 for a missing path', (done) => {
			request(app)
				.get('/api/books')
